...
CREATE TABLE activities (
  id int NOT NULL DEFAULT NEXTVAL ('activities_seq'),
  title varchar(255) DEFAULT NULL,
  message text,
  activity_type smallint DEFAULT NULL,
  allow_comment smallint DEFAULT NULL,
  ...
  image_updated_at timestamp(0) DEFAULT NULL,
...
ALTER SEQUENCE activities_seq RESTART WITH 138;
/*!40101 SET character_set_client = @saved_cs_client */;

CREATE INDEX index_activities_on_classroom_id ON activities (classroom_id);
CREATE INDEX index_activities_on_school_user_id ON activities (school_user_id);
CREATE INDEX index_activities_on_school_id ON activities (school_id);
...
INSERT INTO `schema_migrations` VALUES ('20151118182214'),('20151118183247'),('20151118194159'),('20151119030032'),('20151119030409'),('20151119031025'),('20151119144123'),('20151119145131'),('20151119145329'),('20151119145738'),('20151119145825'),('20151120213435'),('20151121002003'),('20151122031018'),('20151214004419'),('20160115172657'),('20160115174506'),('20160202171318'),('20160218192208'),('20160218194111'),('20160314174936'),('20160324144602');
