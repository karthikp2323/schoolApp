jQuery(document).ready(function($){
    ...
    $.ajax({
        statusCode: {
            200: function() {
                setTimeout(function () {
                    jQuery('.loading-container').addClass('loading-inactive');
                }, 1000);
            }
        },
    });
    ...
    $.each(popovers, function () {
        $(this).popover({
            html: true,
            template: '<div class="popover ' + $(this).data("class") + $(this).data("titleclass") + '">Popover right</h3><div class="popover-content"></div></div>'
        });
    });
